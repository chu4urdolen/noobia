...
constexpr char CAPTURE_PREFIX[] = "cam_";
constexpr uint32_t SD_CLOCK_KHZ = 4000;
constexpr uint32_t CAMERA_SEQUENCE_INTERVAL_MS = 1000;
constexpr uint32_t IR_SEQUENCE_INTERVAL_MS = 100;
constexpr uint32_t RSSI_THREAD_DURATION_MS = 10000;
constexpr uint32_t RSSI_THREAD_INTERVAL_MS = 1000;
constexpr uint32_t IR_THREAD_DURATION_MS = 10000;
constexpr uint32_t IR_THREAD_INTERVAL_MS = 1000;
constexpr uint32_t IR_THREAD_WINDOW_MS = 100;
constexpr uint32_t IR_CAPTURE_RESOLUTION_HZ = 1000000;
constexpr uint32_t IR_CAPTURE_IDLE_US = 15000;
constexpr uint32_t IR_CAPTURE_MIN_PULSE_US = 2;
constexpr uint32_t ENV_THREAD_INTERVAL_MS = 2500;
...
constexpr unsigned VM_LAST_STATUS = 144;
constexpr unsigned VM_LAST_CLEAR = 145;
...
constexpr unsigned CAMERA_SEQUENCE_STEP = 217;
constexpr unsigned CAMERA_SEQUENCE = 218;
constexpr unsigned IR_SEQUENCE_STEP = 219;
constexpr unsigned IR_SEQUENCE = 220;
constexpr unsigned RSSI_SNAPSHOT = 221;
constexpr unsigned IR_SNAPSHOT = 222;
constexpr unsigned ENV_SNAPSHOT = 223;
constexpr unsigned ENV_TEMPERATURE = 224;
constexpr unsigned ENV_HUMIDITY = 225;
constexpr unsigned IR_REPLAY = 226;
constexpr unsigned RSSI_THREAD_START = 230;
constexpr unsigned RSSI_THREAD_STOP = 231;
constexpr unsigned RSSI_THREAD_STATUS = 232;
constexpr unsigned RSSI_THREAD_POP = 233;
constexpr unsigned RSSI_THREAD_POLL = 234;
constexpr unsigned IR_THREAD_START = 235;
constexpr unsigned IR_THREAD_STOP = 236;
constexpr unsigned IR_THREAD_STATUS = 237;
constexpr unsigned IR_THREAD_POP = 238;
constexpr unsigned IR_THREAD_POLL = 239;
constexpr unsigned ENV_THREAD_START = 240;
constexpr unsigned ENV_THREAD_STOP = 241;
constexpr unsigned ENV_THREAD_STATUS = 242;
constexpr unsigned ENV_THREAD_POP = 243;
constexpr unsigned ENV_THREAD_POLL = 244;
constexpr unsigned RSSI_THREAD_FIELD = 245;
constexpr unsigned IR_THREAD_FIELD = 246;
constexpr unsigned ENV_THREAD_FIELD = 247;
constexpr unsigned IR_DICT_REMEMBER = 248;
constexpr unsigned IR_DICT_STATUS = 249;
constexpr unsigned IR_CAPTURE_INSPECT = 250;
